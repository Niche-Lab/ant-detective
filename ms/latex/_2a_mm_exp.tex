...
The image dataset used in this work was divided into seven distinct subsets, as illustrated in \textbf{Figure \ref{fig:dataset_overview}a} and \textbf{Table \ref{tab:dataset_overview}}. The Study 1 and Study 2 subsets were designed to address the first two objectives of this study, respectively.
...
\begin{table}[H]
    ...
    \begin{tabular}{llll}
        ...
        & & \textbf{(Mean $\pm$ Standard Deviation)} & \\
        \midrule
        \textbf{Study 1} & & & \\
        \midrule
        Calibration & 954 & $9.20 \pm 7.37$ & Similar to the subsets A1, A2, and A3 \\
        ...
        Test B03 & 206 & $0.69 \pm 1.26$ & Outdoor and sparse ant distribution \\
        \midrule
        \textbf{Study 2} & & & \\
        \midrule
