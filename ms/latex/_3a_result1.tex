...
Conversely, subset B03 showed consistent improvement: mAP@0.5 increased from 50.6\% (64 images) to 63.6\% (256 images) to 72.2\% (1024 images), suggesting that marginal performance gains correlate with background complexity.
...
\textit{Alt text}: A graph showing how well the model performs on different data sets (indicated by different colors) using various numbers of calibration images. 
