...
The image dataset used in this work was divided into seven distinct subsets, as illustrated in \textbf{Figure \ref{fig:dataset_overview}a, \ref{fig:s2_slicing}}, and \textbf{Table \ref{tab:dataset_overview}}. The Study 1 and Study 2 subsets were designed to address the first two research objectives, respectively.
...
\begin{table}[H]
    ...
    \begin{tabular}{llll}
        ...
        \textbf{Study 1} & & & \\
        \midrule
        Calibration & 954 & $9.20 \pm 7.37$ & Same imaging setup as subsets A01-A03\\ & & & (Collected at different time points)\\
