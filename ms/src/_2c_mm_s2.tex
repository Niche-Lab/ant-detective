...
These three steps yielded three distinct transfer learning strategies: (A) No target fine-tuning + Unsupervised SAHI tuning, (B) Target fine-tuning + Unsupervised SAHI tuning, and (C) Target fine-tuning + Supervised SAHI tuning. Performance assessment utilized mAP@0.5 metrics evaluated over 50 iterations, with statistical comparisons conducted between the three strategies using grid search to establish performance upper bounds.
